...
<center>
<h1 style="color:blue" >ADDMISSION FEES</h1>
<form action="adsfee.jsp" method="post">
 ROLE:
    <select name="prole">        
...
PreparedStatement ps=con.prepareStatement("select * from paddfee where sbranch='"+prole+"'" );
