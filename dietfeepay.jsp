...
<h1 style="color:blue" >DIETARY CHARGES FEE LIST..</h1>
</font>
...
while(rs.next())
{
 ...
 %>
<table>
<tr><td>CONDONATION CODE: </td><td><input type="text" name="id" value="6346" readonly="readonly"></td></tr>
...
<tr><td>DIETARY ROOM CHARGES FEE : </td><td><input type="number" name="pdietaryfee"></input></td></tr>
