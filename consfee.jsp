...
<center>
<h1 style="color:blue" >CONSULTANCY FEE</h1>
<form action="consfee.jsp" method="post">
 ROLE:
    <select name="prole">        
...
PreparedStatement ps=con.prepareStatement("select * from pconfee where sbranch='"+prole+"'" );
