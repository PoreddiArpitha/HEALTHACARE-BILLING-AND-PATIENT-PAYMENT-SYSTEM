...
">
        ...
        <nav>
             ...
             <li><a href="adminhome.jsp">HOME</a></li>
                           <li><a href="consfee.jsp">CONSULTATION FEE </a></li>            
                
               <li>   <a href="adsfee.jsp"> ADDMISSION FEE</a></li>
                <li><a href="roomfee.jsp">ROOM CHARGES </a></li>
                
               <li> <a href="bedfee.jsp">BED DCHARGES</a></li>
  ...
  <center>
<h1 style="color:blue" >MEDICATION FEES</h1>
<form action="medifee.jsp" method="post">
 ROLE:
    <select name="prole">        
...
String branch=request.getParameter("prole");
...
PreparedStatement ps=con.prepareStatement("select * from ssac where sbranch='"+branch+"'" );
