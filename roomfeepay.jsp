...
<h1 style="color:blue" >ROOM CHARGES FEE LIST..</h1>
</font>
...
while(rs.next())
{
 ...
 %>
<table>
<tr><td>ROOM CHARGES CODE: </td><td><input type="text" name="id" value="7702" readonly="readonly"></td></tr>
...
<tr><td>ROOM CHARGES FEE : </td><td><input type="number" name="proomfee"></input></td></tr>
