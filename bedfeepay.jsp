...
">
  ...
  <li>                    <a href="nurfeepay.jsp"> </a>NURSING CHARGES</li>
      			...
      			<ul class="slides">
                      ...
                      data-wow-delay="0.8s" alt="slide1img"> 
      			 	  ...
      			 	  <li class="slide">
                      	...
                      	<p class="wow fadeInUp" data-wow-delay="0.8s">Billing systems in a hospital or medical billing software automate the manual task of billing to ensure faster payment. This benefits providers by speeding up processing, improving workflow, and tracking patient information</p>
                      <img src="images/img2.jpeg" width="317" height="256" class="wow fadeInRight" 
                      data-wow-delay="0.8s" alt="slideimg2"> 
                      </li>
     			 	  <li class="slide">
                      	<h5 class=img src="images\aa.jpg"></h5>
                      	<p class="wow fadeInUp" data-wow-delay="0.8s">Billing systems in a hospital or medical billing software automate the manual task of billing to ensure faster payment. This benefits providers by speeding up processing, improving workflow, and tracking patient information   </p>
                      <img src="images/img3.jpeg" width="317" height="256" class="wow fadeInRight" 
                      data-wow-delay="0.8s" alt="slideimg2"> 
                      </li>
        		  </ul>
            </div>
...
<h1 style="color:blue" >BED CHARGES FEE LIST..</h1>
</font>
...
while(rs.next())
{
 ...
 %>
<table>
<tr><td>BED CHARGES CODE: </td><td><input type="text" name="id" value="7997" readonly="readonly"></td></tr>
...
<tr><td>BED CHARGES FEE : </td><td><input type="number" name="pbedfee"></input></td></tr>
