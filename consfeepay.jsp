...
">
        ...
        <nav>
             <ul id="navigations">
             <li><a href="consfeepay.jsp">CONSULTANCY FEE</a></li>
      			...
      			<ul class="slides">
                      ...
                      data-wow-delay="0.8s" alt="slideimg2"> 
     			 	  ...
     			 	  <li class="slide">
                      	...
                      	<p class="wow fadeInUp" data-wow-delay="0.8s">Billing systems in a hospital or medical billing software automate the manual task of billing to ensure faster payment. This benefits providers by speeding up processing, improving workflow, and tracking patient information     </p>
                      <img src="img/svist.jpg" width="317" height="256" class="wow fadeInRight" 
                      data-wow-delay="0.8s" alt="slideimg2"> 
                      </li>
        		  </ul>
            </div>
...
while(rs.next())
{
 ...
 %>
<table>
<tr><td>CONSULTATION FEE CODE: </td><td><input type="text" name="id" value="1234" readonly="readonly"></td></tr>
...
<tr><td>CONSULTATION FEE : </td><td><input type="number" name="pconsfee"></input></td></tr>
...
<div class="sendfeedback">
  	  <h2>Send Feedback</h2>
            <form action="Jntufee" method="post">
            <h6>Your Name:</h6>
