...
">
        ...
        <nav>
             <ul id="navigations">
             <li><a href="consfeepay.jsp">CONSULTATION</a></li>
                         
                
               <li>   <a href="adsfeepay.jsp"> ADDMISSION	</a></li>
  ...
  <li>   <a href="icufeepay.jsp">ICU CHARGES</a></li>
...
<form name="MY Form" action="stablescon.jsp" method="post"">
<center>
<font face="algerian" size:5px>
<h1 style="color:blue" >ADDMISSION FEE LIST..</h1>
</font>
<%HttpSession httpSession = request.getSession(true);
String pid = (String)httpSession.getAttribute("pid");
String pid1=null,name=null;
System.out.print("pidddddd"+pid);
...
while(rs.next())
{
 ...
 %>
<table>
<tr><td>ADDMISSION FEE CODE: </td><td><input type="text" name="id" value="9101" readonly="readonly"></td></tr>
<tr><td>PATIENT ID: </td><td><input type="text" name="pid" value=<%=pid1 %> readonly="readonly"></input></td></tr>
...
<tr><td>DEPARTMENT : </td><td> <select name="pdep">
                <option value="CASHIER">CAHSIER</option>
...
<tr><td>ADDMISSION FEE : </td><td><input type="number" name="paddfee"></input></td></tr>
