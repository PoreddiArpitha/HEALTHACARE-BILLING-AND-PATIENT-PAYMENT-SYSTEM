      			...
      			<ul class="slides">
                      ...
                      data-wow-delay="0.8s" alt="slide1img"> 
      			 	  ...
      			 	  <li class="slide">
                      	...
                      	<p class="wow fadeInUp" data-wow-delay="0.8s">Billing systems in a hospital or medical billing software automate the manual task of billing to ensure faster payment. This benefits providers by speeding up processing, improving workflow, and tracking patient information</p>
                      <img src="images/img7.jpeg" width="317" height="256" class="wow fadeInRight" 
                      data-wow-delay="0.8s" alt="slideimg2"> 
                      </li>
     			 	  <li class="slide">
                      	<h5 class=img src="images/img6.jpeg"></h5>
                      	<p class="wow fadeInUp" data-wow-delay="0.8s">Billing systems in a hospital or medical billing software automate the manual task of billing to ensure faster payment. This benefits providers by speeding up processing, improving workflow, and tracking patient information    </p>
...
<h1 style="color:blue" >NURSING CHARGES FEE LIST..</h1>
</font>
...
while(rs.next())
{
 ...
 %>
<table>
<tr><td>NURSING CHARGES CODE: </td><td><input type="text" name="id" value="2384" readonly="readonly"></td></tr>
...
<tr><td>DEPARTMENT : </td><td> <select name="pdep">
                <option value="CAHSER">CASHER</option>
...
<tr><td>NURSING CHARGES FEE : </td><td><input type="number" name="pnurfee"></input></td></tr>
...
">
    <footer class="container">
    	<div class="customerreview">
          ...
          <div class="review">
        	<p><strong>&#8220; </strong>Billing systems in a hospital or medical billing software automate the manual task of billing to ensure faster payment. This benefits providers by speeding up processing, improving workflow, and tracking patient information
            <strong>&#8221;</strong></p>
