...
">
  ...
  <li>    <a href="icufee.jsp"> ICU CHARGES</a></li>
  ...
  <center>
<h1 style="color:blue" >BED CHARGES FEES</h1>
<form action="bedfee.jsp" method="post">
 ROLE:
    <select name="sbranch">        
...
PreparedStatement ps=con.prepareStatement("select * from sproject where sbranch='"+branch+"'" );
