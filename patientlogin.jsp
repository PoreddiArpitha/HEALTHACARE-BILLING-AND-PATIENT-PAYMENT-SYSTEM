...
<div class="contactwrapper">
  <div id="fees" class="container">
        <h1 style="color:blue" >PATIENT LOGIN...</h1>
        <form name="MY Form"action="patientlogincon.jsp" method="post">
...
<!--forgot password-->
<input type="submit" value="LOGIN" style="height:30px; width:70px; margin-left:auto; margin-right:auto; margin-top:-25%; margin-bottom:0%; background-color:#ffffff;">
<a href="./fee.html">
</a>
...
<h3 class="wow fadeInUp" data-wow-delay="0.3s">OUR SPECIALITY</h3>
                                 <ul class="slides">
          	 	 <li class="slide">
                    <div class="item">
                          <img src="images/img2.jpeg" width="180" height="100" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h2>24/7</h2>
                      </div> <!-- end of item-->
                      
                   <div class="item2">
                          <img src="images/img4.jpeg" width="180" height="100" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h2>EMERGENCY </h2>
                      </div> <!-- end of item-->
                   ...
                   <div class="item3">
                          ...
                          <img src="images/img6.jpeg" width="180" height="100" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h2>CRITICAL CARE</h2>
                      </div> <!-- end of item-->
                  </li>
