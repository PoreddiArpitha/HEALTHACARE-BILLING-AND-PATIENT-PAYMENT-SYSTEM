...
">
  ...
  <center>
<h1 style="color:blue" >DIETARY CHARGES FEES</h1>
<form action="dietfee.jsp" method="post">
 ROLE:
    <select name="prole">        
...
PreparedStatement ps=con.prepareStatement("select * from scondo where sbranch='"+prole+"'" );
