...
">
  ...
  <center>
<h1 style="color:blue" >ICU ROOM CHARGES FEES</h1>
<form action="icufee.jsp" method="post">
 ROLE:
    <select name="prole">        
...
PreparedStatement ps=con.prepareStatement("select * from picu where sbranch='"+prole+"'" );
